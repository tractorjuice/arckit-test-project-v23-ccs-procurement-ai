...
This is an **ArcKit architecture governance project** — not a software codebase. It generates architecture documents (markdown) for the **AI Procurement Intelligence Platform** at Crown Commercial Service.
...
Expected artifacts for project 001 (AI Procurement Intelligence Platform):
...
Crown Commercial Service (CCS) is an executive agency of the Cabinet Office responsible for improving government commercial and procurement activity. CCS manages over £30 billion in annual procurement spend across frameworks including G-Cloud, Digital Outcomes and Specialists (DOS), and Technology Services. With thousands of suppliers and millions of contract records, AI offers transformative potential for procurement intelligence.

### Compliance Context

UK Government civilian agency (Cabinet Office). Applicable frameworks: GDS Service Standard, Technology Code of Practice (TCoP), NCSC Cyber Assessment Framework, ATRS for AI tools, UK GDPR, HM Treasury Green Book, AI Playbook, Public Contracts Regulations 2015.

### Key Stakeholders

CCS (procurement policy), Cabinet Office (oversight), Government departments (customers), suppliers (G-Cloud/DOS listed), GDS (digital standards), NAO (audit), Crown Representatives.
